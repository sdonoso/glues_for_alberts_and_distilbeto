python run_glue.py \
  ...
  --output_dir /data/sedonoso/all_results/result-paws-x/result_albeto_base \
...
python run_glue.py \
  ...
  --train_file /data/sedonoso/datasets/PAWS-X/translated_train.json \
  --validation_file /data/sedonoso/datasets/PAWS-X/dev_2k.json \
  --output_dir /data/sedonoso/all_results/result-paws-x/result_albeto_base2 \
  --use_fast_tokenizer True \
  --do_train \
  --do_eval \
  --evaluation_strategy epoch \
...
python run_glue.py \
  ...
  --max_seq_length 512 \
  --train_file /data/sedonoso/datasets/datasets/PAWS-X/translated_train.json \
  --validation_file /data/sedonoso/PAWS-X/dev_2k.json \
  --output_dir /data/sedonoso/all_results/result-paws-x/result_albeto_base3 \
  --use_fast_tokenizer True \
  --do_train \
  --do_eval \
  --evaluation_strategy epoch \
